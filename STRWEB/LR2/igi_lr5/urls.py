...
from museum.views import contacts_api
from museum.views import toys_view

urlpatterns = [
    path('set-slider-settings/', views.set_slider_settings, name='set_slider_settings'),
    ...
    path('add-to-cart/<int:exhibition_id>/', views.add_to_cart, name='add_to_cart'),
